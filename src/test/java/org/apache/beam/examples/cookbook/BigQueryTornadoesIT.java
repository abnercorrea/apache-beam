 ...
 * "org.apache.beam.examples.cookbook.BigQueryTornadoesIT" BigQuery dataset to be created before running.
 *
 ...
 *  --tests org.apache.beam.examples.cookbook.org.apache.beam.examples.cookbook.BigQueryTornadoesIT
...
public class BigQueryTornadoesIT {
  ...
  public void testE2EBigQueryTornadoesWithExport() throws Exception {
    ...
    options.setOutput(
        String.format(
            "%s.%s", "org.apache.beam.examples.cookbook.BigQueryTornadoesIT", "monthly_tornadoes_" + System.currentTimeMillis()));
  ...
  public void testE2eBigQueryTornadoesWithStorageApi() throws Exception {
    ...
    options.setOutput(
        String.format(
            "%s.%s",
            "org.apache.beam.examples.cookbook.BigQueryTornadoesIT", "monthly_tornadoes_storage_" + System.currentTimeMillis()));
